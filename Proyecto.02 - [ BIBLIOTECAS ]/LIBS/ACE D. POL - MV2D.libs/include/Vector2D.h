...
public:
	...
	// Funcion AUXILIAR define las direcciones:
...
int dirInv(Vector2D dir);		// devuelve la direccion inversa (-1 = parado)
int contrario(int d);			// devuelve el numero contrario (par|impar)
int act(Vector2D dir);			// devuelve la direccion actual (-1 = parado)
